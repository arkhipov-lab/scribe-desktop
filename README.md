...
5. Review **Transcript** (editable plain text) and **Summary**, then Copy / Export. After editing the transcript, regenerate the summary manually when you want notes updated.
