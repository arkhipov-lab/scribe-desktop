...
Active, multi-iteration **engineering campaigns** with an explicit quality goal.

Use this folder when work needs a durable plan that:

- spans several product iterations;
- is too detailed for [ROADMAP.md](../../ROADMAP.md) (hypothesis backlog);
- is not review debt ([`.ai/state/debt.md`](../../.ai/state/debt.md));
- is not a one-line product wish ([`.ai/state/product-followups.md`](../../.ai/state/product-followups.md)).
