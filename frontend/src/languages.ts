/** Whisper language codes supported by mlx-whisper / OpenAI Whisper. */
export interface WhisperLanguage {
  code: string;
  label: string;
}

/** Display labels; codes match Whisper `language=` argument. */
...
export function isWhisperLanguage(code: string): boolean {
  return WHISPER_LANGUAGES.some((lang) => lang.code === code);
}

export function languageLabel(code: string): string {
  return WHISPER_LANGUAGES.find((lang) => lang.code === code)?.label ?? code;
}
