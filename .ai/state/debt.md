...
| P-2026-07-27-006 | Measure human review-fix involvement after auto-fix policy | `2026-07-27-pipeline-operator-ux` | P2 | process_metrics | Compare human decisions / review-loop interruptions before vs after auto-fix. Baseline noted in pipeline-operator-ux retrospective (no routine-Low ask this cycle vs prior slices that asked for Low AI-fix). | iteration-retrospective | Next shipped iteration retrospective after this | planned |
